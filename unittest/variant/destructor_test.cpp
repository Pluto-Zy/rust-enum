...
TEST(VariantTestDestructor, Trivial) {
    ...
    static_assert(!std::is_trivially_destructible<variant<std::string&, std::string>>::value);
    ...
    }
    {
        ...
        static_assert(std::is_trivially_destructible<variant<non_trivially_destructible>>::value);
        static_assert(
            std::is_trivially_destructible<variant<int, non_trivially_destructible>>::value
        );
        static_assert(
            std::is_trivially_destructible<variant<int, int, non_trivially_destructible>>::value
        );
    }
}
