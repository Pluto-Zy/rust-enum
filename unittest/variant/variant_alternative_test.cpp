...
TEST(VariantTestVariantAlternative, Basic) {
    ...
    static_assert(std::is_same<typename variant_alternative<0, v>::type, int>::value);
    static_assert(std::is_same<typename variant_alternative<0, const v>::type, const int>::value);
    static_assert(
    ...
    static_assert(std::is_same<typename variant_alternative<1, const v>::type, const int>::value);
    static_assert(
    ...
    static_assert(
        std::is_same<typename variant_alternative<3, const v>::type, const volatile double>::value
    );
    static_assert(
...
TEST(VariantTestVariantAlternative, Reference) {
    ...
    static_assert(std::is_same<typename variant_alternative<1, const v>::type, int&>::value);
    static_assert(std::is_same<typename variant_alternative<1, volatile v>::type, int&>::value);
    static_assert(
        std::is_same<typename variant_alternative<1, const volatile v>::type, int&>::value
    );

    static_assert(std::is_same<typename variant_alternative<2, v>::type, const int&>::value);
    static_assert(std::is_same<typename variant_alternative<2, const v>::type, const int&>::value);
    static_assert(
        std::is_same<typename variant_alternative<2, volatile v>::type, const int&>::value
    );
    static_assert(
        std::is_same<typename variant_alternative<2, const volatile v>::type, const int&>::value
    );
