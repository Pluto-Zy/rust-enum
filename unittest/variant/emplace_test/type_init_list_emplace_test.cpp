...
TEST(VariantTestTypeInitListEmplace, Deleted) {
                       ...
                       std::initializer_list<double>>::value);
  {
...

    {
      ...
      static_assert(has_type_emplace<v, constructible_from_list, list&>::value);
      static_assert(!has_type_emplace<v, constructible_from_list,
                                      std::initializer_list<double>>::value);
      static_assert(
          !has_type_emplace<v, constructible_from_list, list, int>::value);
  ...
  }
  {
...

    {
      ...
      static_assert(has_type_emplace<v, constructible_from_list, list>::value);
      static_assert(
          !has_type_emplace<v, constructible_from_list, list&>::value);
    }
    {
      using v = variant<int, constructible_from_list>;
  ...
  }
  {
...

    {
      ...
      static_assert(
          has_type_emplace<v, constructible_from_list_args, list, int>::value);
      static_assert(has_type_emplace<v, constructible_from_list_args, list,
                                     double>::value);
      static_assert(
          !has_type_emplace<v, constructible_from_list_args, list>::value);
      static_assert(!has_type_emplace<v, constructible_from_list_args, list,
                                      int, int>::value);
    }
    {
...
TEST(VariantTestTypeInitListEmplace, Noexcept) {
  using list = std::initializer_list<int>;
  {
...

    {
      ...
      static_assert(
          !has_noexcept_emplace_v<v, may_throw_constructible, list, int>);
      static_assert(
          std::is_constructible<v, std::in_place_index_t<0>, list, int>::value);
      static_assert(
          has_noexcept_emplace_v<v, may_throw_constructible, list, double>);
    }
  }
}
...
TEST(VariantTestTypeInitListEmplace, BasicBehavior) {
...

  {
    ...
    auto& ref2 =
        x.emplace<constructible_from_init_list_with_arg>({1, 2, 3, 4}, 42);
...
TEST(VariantTestTypeInitListEmplace, ValuelessStrategy) {
  ...
  }
  {
    ...
    EXPECT_THROW(x.emplace<throw_constructible_strategy_default>({1, 2, 3}),
                 int);
    EXPECT_TRUE(x.valueless_by_exception());
    ...
    EXPECT_THROW(x.emplace<throw_constructible_strategy_default>({1, 2, 3}, 4),
                 int);
    EXPECT_TRUE(x.valueless_by_exception());
  }
  {
  ...
  }
  {
    ...
    EXPECT_THROW(x.emplace<throw_constructible_strategy_fallback>({1, 2, 3}),
                 int);
    EXPECT_FALSE(x.valueless_by_exception());
    EXPECT_EQ(x.index(), 0);
    ...
    EXPECT_THROW(x.emplace<throw_constructible_strategy_fallback>({1, 2, 3}, 4),
                 int);
    EXPECT_FALSE(x.valueless_by_exception());
    EXPECT_EQ(x.index(), 0);
    EXPECT_EQ(get<0>(x).value, 2);
  ...
  }
  {
    ...
    EXPECT_THROW(x.emplace<throw_constructible_strategy_novalueless>({1, 2, 3}),
                 int);
    EXPECT_FALSE(x.valueless_by_exception());
  }
}
