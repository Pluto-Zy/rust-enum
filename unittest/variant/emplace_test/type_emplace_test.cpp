...
TEST(VariantTestTypeEmplace, Deleted) {
    ...
    static_assert(has_type_emplace<variant<non_convertible>, non_convertible, int>::value);
    ...
    static_assert(!has_type_emplace<variant<int&, const int&>, int&, const int&>::value);
    static_assert(has_type_emplace<variant<int&, const int&>, const int&, const int&>::value);

    {
        ...
        static_assert(
            has_type_emplace<variant<more_arguments>, more_arguments, int, double, float>::value
        );
        static_assert(
            has_type_emplace<variant<more_arguments>, more_arguments, int, double, double>::value
        );
        static_assert(
            has_type_emplace<variant<more_arguments>, more_arguments, long, double, float>::value
        );
        static_assert(
...
TEST(VariantTestTypeEmplace, Constexpr) {
    ...
    }
    {
        ...
        static_assert(constexpr_emplace_impl(v(3), 1, multiple_args(1, 2, 3), 1, 2, 3));
    }
}
#endif
...
TEST(VariantTestTypeEmplace, Noexcept) {
    ...
    static_assert(has_noexcept_emplace_v<variant<int, long, long long>, long, int>);
    static_assert(has_noexcept_emplace_v<variant<int, long, long long>, long long, float>);
    static_assert(has_noexcept_emplace_v<variant<int, std::string>, int, int>);
    static_assert(!has_noexcept_emplace_v<variant<int, std::string>, std::string, const char*>);
    static_assert(has_type_emplace<variant<int, std::string>, std::string, const char*>::value);
    static_assert(has_noexcept_emplace_v<variant<int, long, int*>, int*, int*>);
    static_assert(has_noexcept_emplace_v<variant<int, long, int*>, int*, std::nullptr_t>);
    ...
    static_assert(has_noexcept_emplace_v<variant<int&, std::string&>, std::string&, std::string&>);
    static_assert(has_noexcept_emplace_v<variant<int&, const int&>, const int&, const int&>);

    {
        ...
        static_assert(!has_noexcept_emplace_v<
                      ...
                      int>);
        static_assert(
            has_type_emplace<variant<may_throw_constructible>, may_throw_constructible, int>::value
        );
        static_assert(has_noexcept_emplace_v<
                      variant<may_throw_constructible>,
                      may_throw_constructible,
