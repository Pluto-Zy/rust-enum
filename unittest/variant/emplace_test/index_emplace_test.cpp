...
TEST(VariantTestIndexEmplace, Deleted) {
    ...
    static_assert(has_index_emplace<variant<long&, int>, 1, long&>::value);
    static_assert(!has_index_emplace<variant<int&, std::string&>, 1, const char(&)[3]>::value);
}
...
TEST(VariantTestIndexEmplace, Constexpr) {
    ...
    }
    {
        ...
        static_assert(constexpr_emplace_impl<1>(v(3), multiple_args(1, 2, 3), 1, 2, 3));
    }
}
#endif
...
constexpr bool has_noexcept_emplace_v =
    noexcept(std::declval<Variant>().template emplace<Index>(std::declval<Args>()...));
...
TEST(VariantTestIndexEmplace, Noexcept) {
    ...
    static_assert(has_noexcept_emplace_v<variant<int, long, long long>, 2, float>);
    static_assert(has_noexcept_emplace_v<variant<int, std::string>, 0, int>);
    static_assert(!has_noexcept_emplace_v<variant<int, std::string>, 1, const char*>);
    ...
    static_assert(has_noexcept_emplace_v<variant<int, long, int*>, 2, std::nullptr_t>);
    ...
    static_assert(has_noexcept_emplace_v<variant<int&, std::string const&>, 1, std::string&>);
    static_assert(has_noexcept_emplace_v<variant<int&, const int&>, 1, const int&>);

    {
        ...
        static_assert(!has_noexcept_emplace_v<variant<may_throw_constructible>, 0, int>);
        static_assert(has_index_emplace<variant<may_throw_constructible>, 0, int>::value);
        static_assert(has_noexcept_emplace_v<variant<may_throw_constructible>, 0, double>);
        static_assert(!has_noexcept_emplace_v<variant<may_throw_constructible, int>, 0, int>);
        static_assert(has_index_emplace<variant<may_throw_constructible, int>, 0, int>::value);
        static_assert(has_noexcept_emplace_v<variant<may_throw_constructible, int>, 0, double>);
        static_assert(!has_noexcept_emplace_v<variant<int, may_throw_constructible>, 1, int>);
        static_assert(has_index_emplace<variant<int, may_throw_constructible>, 1, int>::value);
        static_assert(has_noexcept_emplace_v<variant<int, may_throw_constructible>, 1, double>);
    }
    {
        ...
        static_assert(has_noexcept_emplace_v<variant<more_arguments>, 0, int, double, float>);
        static_assert(has_noexcept_emplace_v<variant<more_arguments>, 0, int, double, double>);
        static_assert(!has_noexcept_emplace_v<variant<more_arguments>, 0, float, double, int>);
        static_assert(has_noexcept_emplace_v<variant<int, more_arguments>, 1, int, double, float>);
