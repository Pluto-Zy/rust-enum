...
void ret_visit_forward_call_operator_test_impl() {
    ...
    }
    {
        ...
        EXPECT_TRUE((fn::check_call<long&, std::string&>(CT_NON_CONST | CT_LVALUE)));
        rust::visit<Ret>(cobj, x1, x2);
        EXPECT_TRUE((fn::check_call<long&, std::string&>(CT_CONST | CT_LVALUE)));
        rust::visit<Ret>(std::move(obj), x1, x2);
        EXPECT_TRUE((fn::check_call<long&, std::string&>(CT_NON_CONST | CT_RVALUE)));
...
void ret_visit_forward_argument_test_impl() {
    ...
    }
    {
        ...
        EXPECT_TRUE((fn::check_call<const int&, const std::string&, long&&>(expected)));
    }
    {
        using v = variant<int, long, double, std::string>;
        ...
        rust::visit<Ret>(obj, std::as_const(x1), std::as_const(x2), std::move(x3), std::move(x4));
        EXPECT_TRUE((fn::check_call<const long&, const std::string&, int&&, double&&>(expected)));
    }
    {
        using v = variant<int, long, double, int*, std::string>;
        v x1(3l), x2("hello"), x3(nullptr), x4(1.1);
...
void ret_visit_return_type_test_impl() {
...

    {
        ...
        static_assert(std::is_same<decltype(rust::visit<Ret>(std::move(obj))), Ret>::value);
        static_assert(std::is_same<decltype(rust::visit<Ret>(std::move(cobj))), Ret>::value);
    }
    {
        using v = variant<int>;
        v x(3);
        static_assert(std::is_same<decltype(rust::visit<Ret>(obj, x)), Ret>::value);
        static_assert(std::is_same<decltype(rust::visit<Ret>(cobj, x)), Ret>::value);
        static_assert(std::is_same<decltype(rust::visit<Ret>(std::move(obj), x)), Ret>::value);
        static_assert(std::is_same<decltype(rust::visit<Ret>(std::move(cobj), x)), Ret>::value);
    }
    {
        using v = variant<int, long, double>;
        v x(3l);
    ...
    }
    {
        using v = variant<int, long, double, std::string>;
        v x1(3l), x2("hello"), x3(2), x4(1.1);
        static_assert(std::is_same<decltype(rust::visit<Ret>(obj, x1, x2, x3, x4)), Ret>::value);
        static_assert(std::is_same<decltype(rust::visit<Ret>(cobj, x1, x2, x3, x4)), Ret>::value);
        static_assert(
            std::is_same<decltype(rust::visit<Ret>(std::move(obj), x1, x2, x3, x4)), Ret>::value
        );
        static_assert(
            std::is_same<decltype(rust::visit<Ret>(std::move(cobj), x1, x2, x3, x4)), Ret>::value
        );
    }
    {
        using v = variant<int, long, double, int*, std::string>;
    ...
    }
    {
        ...
        float data3 = 5.f;
        v x1(data1), x2(data2), x3(data3);
        static_assert(std::is_same<decltype(rust::visit<Ret>(obj, x1, x2, x3)), Ret>::value);
        static_assert(std::is_same<decltype(rust::visit<Ret>(cobj, x1, x2, x3)), Ret>::value);
        static_assert(
            std::is_same<decltype(rust::visit<Ret>(std::move(obj), x1, x2, x3)), Ret>::value
        );
        static_assert(
            std::is_same<decltype(rust::visit<Ret>(std::move(cobj), x1, x2, x3)), Ret>::value
        );
    }
}
...
TEST(VariantTestReturnVisit, ReturnType) {
...

    {
        ...
        auto&& r4 = rust::visit<const simple_base&&>(identity {}, std::move(std::as_const(x)));
...
TEST(VariantTestReturnVisit, DerivedFromVariant) {
...

    {
        ...
        struct evil_variant : variant<int, long, double>, std::tuple<int>, evil_variant_base {
...

    {
        ...
        EXPECT_THROW(rust::visit<void>(very_useful_visitor, my_variant(3), x), bad_variant_access);
        EXPECT_THROW(rust::visit<void>(very_useful_visitor, x, my_variant(3)), bad_variant_access);
    }
}
...
TEST(VariantTestReturnVisit, PerfectReturn) {
    {
        ...
        EXPECT_EQ(rust::visit<ret>(identity {}, variant<int, short>((short) 13)).x, 13);
        ...
        using v = variant<convertible_to_immobile_one, convertible_to_immobile_other>;
        EXPECT_EQ(rust::visit<ret>(identity {}, v(convertible_to_immobile_one())).x, 1729);
        EXPECT_EQ(rust::visit<ret>(identity {}, v(convertible_to_immobile_other())).x, 1138);
    }
    {
...
TEST(VariantTestReturnVisit, ImmobileFunction) {
    {
        ...
        EXPECT_DOUBLE_EQ(rust::visit<double>(std::as_const(visitor), v { 3.14 }), 3.14);
