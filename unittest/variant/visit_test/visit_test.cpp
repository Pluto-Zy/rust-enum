...
TEST(VariantTestVisit, RobustAgainstADL) {
    ...
    rust::visit([](auto) {}, x);
    rust::visit([](auto) -> incomplete_holder<incomplete>* { return nullptr; }, x);
    rust::visit<void>([](auto) {}, x);
    rust::visit<void*>([](auto) -> incomplete_holder<incomplete>* { return nullptr; }, x);
}
...
TEST(VariantTestVisit, ForwardArgument) {
    ...
    }
    {
        ...
        rust::visit(obj, std::as_const(x1), std::as_const(x2), std::move(x3), std::move(x4));
...
TEST(VariantTestVisit, ReturnType) {
...

    {
        ...
        static_assert(std::is_same<decltype(rust::visit(std::move(obj))), fn&&>::value);
        static_assert(std::is_same<decltype(rust::visit(std::move(cobj))), const fn&&>::value);
    }
    {
        using v = variant<int>;
        v x(3);
        static_assert(std::is_same<decltype(rust::visit(obj, x)), fn&>::value);
        static_assert(std::is_same<decltype(rust::visit(cobj, x)), const fn&>::value);
        static_assert(std::is_same<decltype(rust::visit(std::move(obj), x)), fn&&>::value);
        static_assert(std::is_same<decltype(rust::visit(std::move(cobj), x)), const fn&&>::value);
    }
    {
        using v = variant<int, long, double>;
        v x(3l);
    ...
    }
    {
        ...
        static_assert(std::is_same<decltype(rust::visit(cobj, x1, x2)), const fn&>::value);
        static_assert(std::is_same<decltype(rust::visit(std::move(obj), x1, x2)), fn&&>::value);
        static_assert(
            std::is_same<decltype(rust::visit(std::move(cobj), x1, x2)), const fn&&>::value
        );
    }
    {
        using v = variant<int, long, double, std::string>;
        v x1(3l), x2("hello"), x3(2), x4(1.1);
        static_assert(std::is_same<decltype(rust::visit(obj, x1, x2, x3, x4)), fn&>::value);
        static_assert(std::is_same<decltype(rust::visit(cobj, x1, x2, x3, x4)), const fn&>::value);
        static_assert(
            std::is_same<decltype(rust::visit(std::move(obj), x1, x2, x3, x4)), fn&&>::value
        );
        static_assert(
            std::is_same<decltype(rust::visit(std::move(cobj), x1, x2, x3, x4)), const fn&&>::value
        );
    }
    {
        using v = variant<int, long, double, int*, std::string>;
...
TEST(VariantTestVisit, DerivedFromVariant) {
    {
        ...
        rust::visit([](auto val) { EXPECT_EQ(val, -1.25f); }, derived_variant { -1.25f });
...

    {
        ...
        rust::visit([](auto val) { EXPECT_DOUBLE_EQ(val, 12.3); }, evil_variant(12.3));
    }
...

    {
        ...
        EXPECT_THROW(rust::visit(very_useful_visitor, my_variant(3), x), bad_variant_access);
        EXPECT_THROW(rust::visit(very_useful_visitor, x, my_variant(3)), bad_variant_access);
    }
}
...
TEST(VariantTestVisit, ImmobileFunctionVisit) {
    {
        ...
        EXPECT_DOUBLE_EQ(rust::visit(std::move(std::as_const(visitor)), v { 1.414 }), 1.414);
    }
    {
        using v = variant<int, double>;
